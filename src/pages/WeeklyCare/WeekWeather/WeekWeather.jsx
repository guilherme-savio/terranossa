            ...
            <div className="flex w-full">
                <div className="w-1/2 h-10">
                    <div className="grid grid-cols-3 h-full flex-grow card bg-base-300 rounded-box place-items-center">
                        ...
                        <span className="justify-center">{dayData["wind_kph"]}km/h</span>
                    </div>
                </div>
                ...
                <div className="w-1/2 h-10">
                    <div className="grid grid-cols-3 h-full flex-grow card bg-base-300 rounded-box place-items-center">
                        ...
                        <span className="justify-center">{dayData["humidity"]}%</span>
                    </div>
                </div>
            </div>
            <div className="flex w-full">
                <div className="w-1/2 h-10">
                    <div className="grid grid-cols-3 h-full flex-grow card bg-base-300 rounded-box place-items-center">
                        ...
                        <span className="justify-center">{forecastDay["maxtemp_c"]}°C</span>
                    </div>
                </div>
                <div className="divider divider-horizontal"></div>
                <div className="w-1/2 h-10">
                    <div className="grid grid-cols-3 h-full flex-grow card bg-base-300 rounded-box place-items-center">
                        ...
                        <span className="justify-center">{forecastDay["mintemp_c"]}°C</span>
                    </div>
                </div>
            </div>
        </div>
